...
vim.api.nvim_set_hl(0, "GitConflictCurrent", { bg = "#7f3b4c", fg = colors.text }) -- darker red variant
vim.api.nvim_set_hl(0, "GitConflictIncoming", { bg = "#3b7f57", fg = colors.text }) -- darker green variant
